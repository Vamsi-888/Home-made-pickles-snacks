...
products = [
    {"id": 1, "name": "Gongura Pickle", "price": 120, "image":'images/gongura.jpg'},
    {"id": 2, "name": "Lemon Pickle", "price": 100, "image": 'images/lemon.jpg'},
    {"id": 3, "name": "Chilli Pickle", "price": 130, "image": 'images/chili.jpg'},
    {'id': 4, 'name': 'Chicken Pickle', 'price': 180, 'image': 'images/chicken.jpg'},
        {'id': 5, 'name': 'Prawn Pickle', 'price': 200, 'image': 'images/prawn.jpg'},
    ]
snack_list = [
        ...
        {"id": 9, "name": "Chekkalu", "price": 50, "image": 'images/chekalu.jpg'},
...
def snacks():
    snack_list = [
        ...
        {"id": 9, "name": "Chekkalu", "price": 50, "image": url_for('static', filename='images/chekalu.jpg')},
...
def veg_pickles():
    pickles = [
        {'id': 1, 'name': 'Mango Pickle', 'price': 120, 'image': 'static/mango.jpg'},
        {'id': 2, 'name': 'Lemon Pickle', 'price': 100, 'image': 'static/lemon.jpg'},
    ]
    return render_template('pickles.html', pickles=pickles)
...
def non_veg_pickles():
    pickles = [
        {'id': 3, 'name': 'Chicken Pickle', 'price': 180, 'image':'static/chicken.jpg'},
        {'id': 4, 'name': 'Prawn Pickle', 'price': 200, 'image': 'static/prawn.jpg'},
    ]
    return render_template('pickles.html', pickles=pickles)
